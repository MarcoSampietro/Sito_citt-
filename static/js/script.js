...
function showDetails(section) {
    ...
    if (section === 'citta_vecchia') {
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Biblioteca_universitaria2.jpg')}}" alt="Biblioteca Universitaria" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Eventi2.jpg')}}" alt="Eventi Varsavia" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Varsavia_moderna2.jpg')}}" alt="Varsavia Moderna" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Museo_Chopin2.jpg')}}" alt="Museo Chopin" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Nightlife2.jpg')}}" alt="Nightlife" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Teatro_nazionale2.jpg')}}" alt="Teatro Nazionale" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Mercatini2.jpg')}}" alt="Mercatini di Natale" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Sport2.jpg')}}" alt="Sport Varsavia" class="img-fluid">
        `;
        ...
        content = `
            ...
            <img src="{{url_for('static', filename='immagini/Parco2.jpg')}}" alt="Parco Łazienki" class="img-fluid">
        `;
    }
